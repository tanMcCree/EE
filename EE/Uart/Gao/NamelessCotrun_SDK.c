...
#define NCQ_SDK_DUTY_MAX   2
#define NCQ_SDK_DUTY1 move_with_xy_target(-50,50,&SDK_Duty_Status,1-1)
#define NCQ_SDK_DUTY2 move_with_z_target(-75,0,0,&SDK_Duty_Status,2-1)
