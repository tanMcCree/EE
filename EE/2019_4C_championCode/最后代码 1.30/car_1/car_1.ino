      ...
      //////road=1111111111111111111111111111111111111111111111111
        ...
        Car_L_R_S_Control(85, -25, -25);
         delay(200);
           while(1){
              Car_L_R_S_Control(85, 0, 0);
              if(digitalRead(red_light)==0){cnt_light++;
                break;}
              }
    }
                    ...
                    while(1){
                     digitalWrite(flag_count,0);
                      read_speed();
                           ...
                           if(left_count<85)//130          1111111111111111111111111111111111走
                              Car_L_R_S_Control(85, 20, 20);
                           else 
                              break;
//                           if(left_count>60&&stop1==0)
//                              stop1=1;
//                           if(stop1==1){ Car_L_R_S_Control(85, 0, 0);delay(200);stop1=2;}
                            
                        }
                    ///////////////////////////////////////turn
                     Car_L_R_S_Control(98,23,23);
                     digitalWrite(flag_count,1);
                    // while(1){read_cam();if(road==1) break;}
                    if(cnt_light==1){
                      delay(3700);//4500 4000
                    }
                    else {delay(3500);}
//                     Car_L_R_S_Control(80,30,30);
//                     delay(500);
                  /////
                      Car_L_R_S_Control(85,21,21);//98
                       while(1){
                        read_cam();
                        if(a[1]==0||b[1]==0)
                          break;
...
//                          }
                 ...
                 while(1){
                   digitalWrite(flag_count,0);
                  read_speed();
                  if(left_count<30)  {read_cam(); road=2;cam_control();}//{read_cam(); road=1;cam_control();}
